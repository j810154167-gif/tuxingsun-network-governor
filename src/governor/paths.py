...
CONFLICTING_LAUNCHD_LABELS = ["ai.openclaw.network-governor"]
CONFLICTING_LAUNCHD_PLISTS = [LAUNCH_AGENTS_DIR / f"{label}.plist" for label in CONFLICTING_LAUNCHD_LABELS]
